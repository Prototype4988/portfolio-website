  ...
  return (
    <section id="contact" className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
        ...
        <div className='socials flex flex-row gap-2'>
            ...
            <Link href="https://www.linkedin.com/in/solomon-emmanuel-thompson-i-3487751a4/" target='_blank'>
        ...
        <div>
            ...
            <form className='hidden flex-col' onSubmit={handleSubmit}>
                <div className='mb-6'>
                    ...
                    <input name="email" type="email" id="email" required className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder='xyz@gmail.com'/>
                </div>
                <div className='mb-6'>
                ...
                <button type='submit' className='bg-primary-500 hover:bg-primary-600 text-white fone-medium py-2.5 px-5 rounded-lg w-full'>
                    Send Message
                </button>
